...
/// Creates a [CoffeeDatabase] instance for testing and installs the necessary
/// teardown hooks.
CoffeeDatabase createTestDatabase() {
...
class FakeImageResizeService implements ImageResizeService {
  @override
...
final favoriteFabFinder = find.byType(FloatingActionButton);
final favoritesTabFinder = find.descendant(
  of: find.byType(NavigationDestination),
  matching: find.byIcon(Icons.favorite),
);
final exploreTabFinder = find.descendant(
  of: find.byType(NavigationDestination),
  matching: find.byIcon(Icons.coffee),
);
final errorSnackBarFinder = find.byType(SnackBar);

extension DoubleTap on WidgetTester {
  /// Taps the given widget twice, with the necessary delay between the two
  /// taps to trigger [GestureDetector.onDoubleTap].
